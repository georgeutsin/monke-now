...
export function evaluate(cardGroup: CardGroup): BestHand {
    ...
    let straightMaxCardRank: number = -1;
    let straightLastCardRank: number = -1;
    ...
    if (pairRanks.length >= 2) {
        ...
        return {
            handRank: HandRanks.twoPair, hand: new CardGroup(pairedHigherCards.concat(pairedLowerCards)
